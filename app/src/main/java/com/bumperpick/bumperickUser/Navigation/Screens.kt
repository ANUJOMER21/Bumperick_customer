...
sealed class Screen(val route: String) {
    ...
    object EventCityScreen:Screen("eventCityScreen")
    ...
    object ContestForm:Screen("contest_form/{$EVENT_NAME}/{$EVENT_ID}"){
        fun withid(eventName:String,eventId:String):String{
            return "contest_form/$eventName/$eventId"
        }
    }  object ContestSubmission:Screen("contest_submission/{$EVENT_NAME}/{$EVENT_ID}"){
        fun withid(eventName:String,eventId:String):String{
            return "contest_submission/$eventName/$eventId"
        }
    }
    object ContestResult:Screen("contest_result/{$EVENT_NAME}/{$EVENT_ID}"){
        fun withid(eventName:String,eventId:String):String{
            return "contest_result/$eventName/$eventId"
        }
    }
