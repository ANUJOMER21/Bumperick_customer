...
interface ApiService {
   ...
   suspend fun customer_campaign(@Query("token")token: String):Response<EventModel>
    ...
    @GET("api/customer/events/city")
    suspend fun get_even_city(
        @Query("token") token: String
    ):Response<CustomerEventModel>
    ...
    @FormUrlEncoded
    @POST("api/customer/notifications/destroy")
    suspend fun notification_destroy(@Field("token")token: String,@Field("id")id: String): Response<success_model>
    ...
    @GET("api/customer/contests")
    suspend fun contest(@Query("token")token: String): Response<Constest_Model>
    @GET("api/customer/contests/{id}")
    suspend fun contest_details(@Path("id")id: String,@Query("token")token: String): Response<contest_details>
    @POST("api/customer/contest-registerations/create")
    @FormUrlEncoded
    suspend fun contest_register(@FieldMap map: Map<String, String>): Response<success_model>
    @GET("api/customer/contest-registerations")
    suspend fun contest_registered(@Query("token")token: String): Response<contestregistered>
    @POST("api/customer/contest-registerations/delete/{id}")
    suspend fun contest_delete(@Path("id")id: String,@Query("token")token: String): Response<success_model>
    @POST("api/customer/contest-submissions/create")
    @Multipart
    suspend fun contest_submission(@PartMap map: MutableMap<String, RequestBody>, @Part file: MultipartBody.Part?): Response<success_model>
    @POST("api/customer/contest-submissions/create")
    @Multipart
    suspend fun contest_submission(@PartMap map: MutableMap<String, RequestBody>): Response<success_model>

    @POST("api/customer/reports/store")
    @FormUrlEncoded
    suspend fun report_offer(@FieldMap map: Map<String, String>): Response<success_model>
