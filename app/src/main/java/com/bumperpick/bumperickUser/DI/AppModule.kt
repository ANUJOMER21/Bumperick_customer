...
import com.bumperpick.bumperickUser.Repository.ContestRepositoryImpl
...
val appModule = module {
    ...
    single < Contest_Repository>{ ContestRepositoryImpl(get(), get(), get()) }
    ...
    viewModel { ContestViewmodel(get (),get ()) }
