...
sealed class AccountClick(){
    ...
    object EventCityClick: AccountClick()
        ...
        Column(modifier = Modifier
            ...
            }.background(Color.White), )
            {
                Row (modifier = Modifier.padding(12.dp).align(Alignment.CenterStart)){
                    Icon(painter = painterResource(R.drawable.campaigns),
                        tint = BtnColor,
                        contentDescription = null, modifier = Modifier.size(30.dp),)
                    Spacer(modifier = Modifier.width(12.dp))
                    Text(text = "Campaigns", color = Color.Black, fontSize = 16.sp,modifier = Modifier.align(
            ...
            {
                Row (modifier = Modifier.padding(12.dp).align(Alignment.CenterStart)){
                    Icon(painter = painterResource(R.drawable.event),
                        tint = BtnColor,
                        contentDescription = null, modifier = Modifier.size(30.dp),)
                    Spacer(modifier = Modifier.width(12.dp))
                    Text(text = "Events", color = Color.Black, fontSize = 16.sp,modifier = Modifier.align(
                        Alignment.CenterVertically))
                }
            ...
            Spacer(modifier = Modifier.height(12.dp))
            Box (modifier = Modifier.fillMaxWidth().clickable {
                accountclick(AccountClick.EventCityClick)
            }.background(Color.White), )
            {
                Row (modifier = Modifier.padding(12.dp).align(Alignment.CenterStart)){
                    Icon(painter = painterResource(R.drawable.event),
            ...
            }.background(Color.White), )
            {
                Row (modifier = Modifier.padding(12.dp).align(Alignment.CenterStart)){
                    ...
                    Spacer(modifier = Modifier.width(12.dp))
                    Text(text = "Email to customer care", color = Color.Black, fontSize = 16.sp, modifier = Modifier.align(
                        Alignment.CenterVertically))
                }
