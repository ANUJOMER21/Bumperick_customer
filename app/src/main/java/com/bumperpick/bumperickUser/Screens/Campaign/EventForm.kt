...
fun EventForm(
    ...
    var conf_emailError by remember { mutableStateOf<String?>(null) }
    ...
    fun validateForm(): Boolean {
        ...
        when {
            conf_email.isBlank() -> {
                conf_emailError = "Email is required"
                isValid = false
            }
            !android.util.Patterns.EMAIL_ADDRESS.matcher(conf_email).matches() -> {
                conf_emailError = "Please enter a valid email address"
                isValid = false
            }
            conf_email.length > 100 -> {
                conf_emailError = "Email must be less than 100 characters"
                isValid = false
            }
            conf_email != email -> {
                conf_emailError = "Email does not match"
                isValid = false
            }
        }
                        ...
                        FormField(
                            ...
                            onValueChange = {
                                ...
                                if(conf_email!=email){
                                    ...
                                    conf_emailError = null
                                }
                                            }, // Limit input length
                            placeholder = "Confirm your email address",
                            error = conf_emailError,
                            leadingIcon = Icons.Outlined.Email,
                            keyboardType = KeyboardType.Email,
                            imeAction = ImeAction.Next
                        )
