            ...
            Box(modifier = Modifier.padding(padding)) {
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    Column(modifier = Modifier.background(Color.White)) {
                        ...
                        SearchCard(
                            title = "offers",
                            query = search, onQueryChange = { search = it }) {}
                            ...
                            LazyColumn(
                                ...
                                item {
                                    ...
                                    Row (verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Center, modifier = Modifier.fillMaxWidth()){
                                        Icon(painter = painterResource(R.drawable.left), contentDescription = null,
                                            tint = blueColor,
                                            modifier = Modifier.size(12.dp))
                                        Spacer(modifier = Modifier.width(10.dp))
                                        val text= if(filteredList.isEmpty()) "No offers availed " else if(filteredList.size==1) "1 offer availed" else "${filteredList.size} offers availed"
                                        Text(
                                            text = text,
